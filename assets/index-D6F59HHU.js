 ...
 */function ds(n,t,e){return n?t(n):e==null?void 0:e(n)}const K=class K extends D{static from(t,e,s,r,i=null){console.log(arguments);const o=document.createElement("lesson-card");return o.setAttribute("starttime",t),o.setAttribute("endtime",e),o.setAttribute("lessonname",s),o.setAttribute("cabinet",r.toString()),i&&o.setAttribute("note",i),o}static init(){customElements.define("lesson-card",K)}render(){const{startTime:t,endTime:e,lessonName:s,cabinet:r,note:i}=this;return X`
  ...
  `);let bt=ht;function fs(){return document.createElement("no-lessons-card")}et.init();bt.init();function _e(n){const t=document.querySelector("#month_with_year");t.textContent=n.format("MMMM, YYYY")}function ve(n){const t=document.querySelector("#is_first_week");t.textContent=["Первая неделя","Вторая неделя"][n-1]??`${n} неделя`}const ps="./schemas/schedule.json",$s="2023-09-18",ms=[[null,[null,null,null,"Менеджмент Малышева Н.В.|21 кабинет","Правовое обеспечение проф. деятельности|41 кабинет","Устройство и функционирование ИС|35 кабинет","Устройство и функционирование ИС|35 кабинет"],[null,null,null,null,"Сертификация ИС|35 кабинет","Сертификация ИС|35 кабинет"],["Интеллект. системы и технологии|35 кабинет","Интеллект. системы и технологии|35 кабинет","Управление и автомат. баз данных|35 кабинет","Управление и автомат. баз данных|35 кабинет"],null,[null,null,null,"Менеджмент в проф. деятельности|41 кабинет","Менеджмент в проф. деятельности|41 кабинет"],null],[null,[null,null,null,"Менеджмент Малышева Н.В.|21 кабинет","Правовое обеспечение проф. деятельности|41 кабинет","Устройство и функционирование ИС|35 кабинет","Устройство и функционирование ИС|35 кабинет"],[null,null,null,null,"Сертификация ИС|35 кабинет","Сертификация ИС|35 кабинет"],["Интеллект. системы и технологии|35 кабинет","Интеллект. системы и технологии|35 кабинет","Управление и автомат. баз данных|35 кабинет","Управление и автомат. баз данных|35 кабинет"],null,[null,null,null,null,"Менеджмент в проф. деятельности|41 кабинет"],null]],lt={$schema:ps,firstWeek:$s,weeks:ms};function ye(n,t){let e=1;for(let s=1;s<n;s+=1){if(e===t){e=1;continue}e+=1}return e}function _s(n,t){var e,s;return((s=(e=lt.weeks)==null?void 0:e[t-1])==null?void 0:s[n])||null}const vs={1:["8:00","9:35"],2:["9:45","11:20"],3:["11:40","13:15"],4:["13:25","15:00"],5:["15:10","16:45"],6:["16:55","18:30"],7:["18:35","19:45"]};function ge(n,t){const e=n.day(),s=_s(e,t),r=document.querySelector("main");if(r.innerHTML="",s===null){r.insertAdjacentElement("afterbegin",fs());return}if(Array.isArray(s)){s.forEach((l,u)=>{if(l===null)return;const[d,$]=vs[u+1],[_,S,L]=l.split("|"),b=et.from(d,$,_,S,L);r.insertAdjacentElement("beforeend",b)});return}const[i,o]=s.customTime.split(":"),c=s.lessons;let h=p(n).hour(Number(i)).minute(Number(o)).second(0);c.forEach(l=>{const[u,d,$]=l.split("|"),_=h;h=_.add(95,"m");const S=et.from(_.format("HH:mm"),h.format("HH:mm"),u,d,$);r.insertAdjacentElement("beforeend",S),h=h.add(10,"m")})}var rt;const T=class T{static get selectedDay(){return Ut(T,rt)}static set selectedDay(t){Pt(T,rt,t);const e=ye(t.diff(T.referencePointOfWeeks,"w"),2);_e(t),ve(e),ge(t,e)}};rt=new WeakMap,E(T,"referencePointOfWeeks",p(lt.firstWeek)),Lt(T,rt,p());let st=T;const Gt=document.querySelector("#weeks"),Qt=document.querySelector("#load_more");function ys(n){const t=Kt(n,!0);t.addEventListener("click",()=>{st.selectedDay=n}),Gt.insertBefore(t,Qt);for(let r=1;r<60;r+=1){const i=n.add(r,"day"),o=Kt(i);o.addEventListener("click",()=>{st.selectedDay=i}),Gt.insertBefore(o,Qt)}const e=[...document.querySelector("#weeks").children];let[s]=e;e.forEach(r=>{r.addEventListener("click",()=>{s==null||s.removeAttribute("active"),s=r,r.setAttribute("active","")})})}function gs(n){const t=p(lt.firstWeek);return ye(n.diff(t,"w"),lt.weeks.length)}const $t=p(),Ae=gs($t);_e($t);ys($t);ge($t,Ae);ve(Ae);const wt=document.getElementById("datepicker");wt.valueAsDate=new Date;wt.addEventListener("change",()=>{st.selectedDay=p(wt.value)});
